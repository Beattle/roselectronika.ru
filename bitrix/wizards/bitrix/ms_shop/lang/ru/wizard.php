<?
$MESS["WIZ_TEMPLATE_ADAPT"] = "Шаблон onCloud";
$MESS["WIZ_TEMPLATE_ADAPT_DESCRIPTION"] = "Цветовые параметры и расположение блоков в шаблоне настраиваются в параметрах.";
...
$MESS["WIZ_COMPANY_NAME_DEF"] = "Техника+";
$MESS["WIZ_COMPANY_TELEPHONE"] = "Телефон для обратной связи";
$MESS["WIZ_COMPANY_TELEPHONE_DEF"] = "8 (800) 123-45-67";
$MESS["WIZ_COMPANY_SCHEDULE"] = "Время работы";
$MESS["WIZ_COMPANY_SCHEDULE_DEF"] = "Круглосуточно, без выходных";
...
$MESS["WIZ_COMPANY_COPY_DEF"] = "&copy; Магазин. Все права защищены.";
