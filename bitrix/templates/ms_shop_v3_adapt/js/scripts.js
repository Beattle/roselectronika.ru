	...
	//alert("123");
	 /* var email_user = 1;
	  var i = 1;
                //alert(email_user);
                $.ajax({
                url: "/bitrix/templates/ms_shop_v3_adapt/inc/count_in_cart.php",
                type: "POST",
                dataType: "html",
                ...
                success: function(data){
					i = data;
					alert(i);
                 // $("#subscribe_test_success").html(data);
                  //$("#sub-add-success1").click();
...
/*}else{
	alert("Товар нельзя добавить в корзину!");
}*/
};
