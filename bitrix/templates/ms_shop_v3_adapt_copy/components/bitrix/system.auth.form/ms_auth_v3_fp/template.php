...
{
?>
	<a class="auth-link" href="<?=$arResult["AUTH_URL"]?>"><?=GetMessage("FP_AUTH_LOGIN")?></a>
	<?if($arResult["NEW_USER_REGISTRATION"] == "Y"):?>
	<span>&nbsp;/&nbsp;</span>
	<a class="reg-link" href="<?=$arResult["AUTH_REGISTER_URL"]?>" ><?=GetMessage("FP_AUTH_REGISTER")?></a>
	<?endif;?>
<?
}
else
...
?>
	...
	<span>/</span>
	<a class="logout-link" href="<?=$APPLICATION->GetCurPageParam("logout=yes", Array("logout"))?>"><?=GetMessage("FP_AUTH_LOGOUT")?></a>
<?
}
?>
