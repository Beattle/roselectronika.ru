			...
			<?//if($arResult["AUTH"]["new_user_registration"]=="Y"):?>
					...
					<div class="sale_order_full_table">
						<div class="field">
							...
							<br />
							<input type="text" name="NEW_LAST_NAME" id="new_last_name1" size="40" value="<?=$arResult["AUTH"]["NEW_LAST_NAME"]?><?//=$lastname?>" required="required">
						</div>
						...
						<div class="field">
							...
							<br />
							<input type="text" name="NEW_EMAIL" id="new_email1" size="40" value="<?=$arResult["AUTH"]["NEW_EMAIL"]?><?=$email?>" required="required">
						</div>
						
						<div class="field">
							<label>Телефон<?//echo GetMessage("STOF_NAME")?> <span class="starrequired">*</span></label>
							<br />
							<input type="text" name="NEW_NAME" id="new_name1" size="40" value="<?=$arResult["AUTH"]["NEW_NAME"]?><?//=$firstname?>" required="required"
							>
						</div>
						<div class="field">
							<label>Город<?//echo GetMessage("STOF_NAME")?> <span class="starrequired">*</span></label>
							<br />
							<input type="text" name="NEW_CITY" id="new_city1" size="40" value="<?//=$arResult["AUTH"]["NEW_NAME"]?><?//=$firstname?>" required="required"
							>
						</div>
