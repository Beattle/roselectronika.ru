...
<div class="bx_catalog_grid col<? echo $arParams['LINE_ELEMENT_COUNT']; ?> <? echo $templateData['TEMPLATE_CLASS']; ?>">
	...
	<div data-pid="<?=$arItem['ID']?>" class="product <? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?> <?=$stock?>">
		<div class="bx_catalog_item_container" id="<? echo $strMainID; ?>">
			...
			<a id="<? echo $arItemIDs['PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="bx_catalog_item_images" style="background-image: url(<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>)" title="<? echo $strTitle; ?>">
				<span class="stickers">
					...
					<?if ('Y' == $arParams['SHOW_DISCOUNT_PERCENT']) {?>
						<span id="<? echo $arItemIDs['DSC_PERC']; ?>" class="sticker discount" style="display:<? echo (0 < $arItem['MIN_PRICE']['DISCOUNT_DIFF_PERCENT'] ? '' : 'none'); ?>;">-<? echo $arItem['MIN_PRICE']['DISCOUNT_DIFF_PERCENT']; ?>%</span>
					<?}?>
				</span>
			</a>
			<?if ($arItem['SECOND_PICT']) {?>
				<a id="<? echo $arItemIDs['SECOND_PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="bx_catalog_item_images_double"
					style="background-image: url(<? echo (!empty($arItem['PREVIEW_PICTURE_SECOND']) ? $arItem['PREVIEW_PICTURE_SECOND']['SRC'] : $arItem['PREVIEW_PICTURE']['SRC']); ?>)" title="<? echo $strTitle; ?>">
					<span class="stickers">
					<?
					foreach ($arItem['DISPLAY_PROPERTIES'] as $arOneProp)
					{
			...
			<!-- Simple product -->
                ...
                <? echo '<pre>'.print_r($$arItem['DISPLAY_PROPERTIES'],true).'</pre>';?>
				...
				<?} else {?>
					...
					<?} else {?>
						<div class="bx_catalog_item_controls no_touch tac">
							<a class="btn bt2 detail-btn" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>">
								<?echo ('' != $arParams['MESS_BTN_DETAIL'] ? $arParams['MESS_BTN_DETAIL'] : GetMessage('CT_BCT_TPL_MESS_BTN_DETAIL'));?>
							</a>
						</div>
					<?}?>
					
					<div class="bx_catalog_item_controls touch tac">
						<a class="btn bt2 detail-btn" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>">
							<?echo ('' != $arParams['MESS_BTN_DETAIL'] ? $arParams['MESS_BTN_DETAIL'] : GetMessage('CT_BCT_TPL_MESS_BTN_DETAIL'));?>
						</a>
					</div>
...
<? //s echo '<pre>'.print_r($arParams,true).'</pre>';?>