...
//demo discount
	...
	if(!($dbDiscount->Fetch()))
	{
		...
		{
			$dbSect = CIBlockSection::GetList(Array(), Array("IBLOCK_TYPE" => "catalog", "IBLOCK_ID"=>$IBLOCK_CATALOG_ID, "CODE" => "telefony", "IBLOCK_SITE_ID" => WIZARD_SITE_ID));
...
//delete 1c props
	...
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/featured.php", array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/sect_sidebar.php", array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/compare.php", array("CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
}
?>