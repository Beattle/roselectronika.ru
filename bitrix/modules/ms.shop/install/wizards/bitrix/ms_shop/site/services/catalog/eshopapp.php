...
$currentInstallEshoApp = COption::GetOptionString("ms_shop", "installEshopApp", "N", WIZARD_SITE_ID);
if ($currentInstallEshoApp != "Y" && $installEshopApp == "Y")
	$wizardInstallEshopApp = true;
COption::SetOptionString("ms_shop", "installEshopApp", $installEshopApp, false, WIZARD_SITE_ID);
