	...
	<!--
		...
		<div class="ct_diff">
			...
			<?if($arResult["DIFFERENT"]):?>
				<a class="btn bt1 active" href="<?=htmlspecialcharsbx($APPLICATION->GetCurPageParam("DIFFERENT=N",array("DIFFERENT")))?>" rel="nofollow"><?=GetMessage("CATALOG_ALL_CHARACTERISTICS")?></a>
			<?else:?>
				<span class="btn disabled"><?=GetMessage("CATALOG_ALL_CHARACTERISTICS")?></span>
			<?endif?>
			
			<?if(!$arResult["DIFFERENT"]):?>
				<a class="btn bt1 active" href="<?=htmlspecialcharsbx($APPLICATION->GetCurPageParam("DIFFERENT=Y",array("DIFFERENT")))?>" rel="nofollow"><?=GetMessage("CATALOG_ONLY_DIFFERENT")?></a>
			<?else:?>
